...
(function() {
  var change_td, checkin_selected, checkout_selected, get_col_idx, get_selected_class, get_selected_id, get_selected_ids, get_td, initialize_table;
        ...
        "aButtons": [
          {
            ...
            'fnClick': function(nButton, oConfig, oFlash) {
              ...
              if (selected.length < 1) {
                ...
                return window.location = "/devices/" + device_class + "/" + pk + "/edit/";
              }
            }
          }
        ]
  ...
  checkin_selected = function() {
    ...
    pk = get_selected_id(selected);
    device_type = get_selected_class(selected);
    return window.location = "/devices/" + device_type + "/" + pk + "/checkin";
  };
