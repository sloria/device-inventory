...
(function() {
  var change_td, checkin_selected, checkout_selected, delete_selected, get_selected_id, get_selected_ids, initialize_table;
  ...
  delete_selected = function() {
    ...
    */
    ...
    selected = oTT.fnGetSelected(oTable);
    pk = get_selected_id(selected);
    return window.location = "/devices/" + pk + "/delete";
  };
  ...
  window.get_td = function(column_name, pk) {
    /*
