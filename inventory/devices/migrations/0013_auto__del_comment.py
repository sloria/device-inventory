...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'devices_comment')


    def backwards(self, orm):
        # Adding model 'Comment'
        db.create_table(u'devices_comment', (
            ...
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['devices.Ipad'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'devices', ['Comment'])
    ...
    models = {
        ...
        u'devices.adapter': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'purchased_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 14, 0, 0)'})
        },
        u'devices.case': {
