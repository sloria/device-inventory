...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Device.condition'
        db.add_column(u'devices_device', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='EX', max_length=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Device.condition'
        db.delete_column(u'devices_device', 'condition')


        # Changing field 'Device.lendee'
        db.alter_column(u'devices_device', 'lendee_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['devices.Lendee'], unique=True, null=True))
    ...
    models = {
        ...
        u'devices.device': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lendee': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['user.Lendee']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
