...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'devices_comment', 'created_at')

        # Deleting field 'Comment.updated_at'
        db.delete_column(u'devices_comment', 'updated_at')
