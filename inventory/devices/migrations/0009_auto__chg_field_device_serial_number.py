...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.serial_number'
        db.alter_column(u'devices_device', 'serial_number', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Device.serial_number'
        db.alter_column(u'devices_device', 'serial_number', self.gf('django.db.models.fields.CharField')(default=1, max_length=200, unique=True))
    ...
    models = {
        ...
        u'devices.device': {
            ...
            'serial_number': ('django.db.models.fields.CharField', [], {'max_length': '200', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
